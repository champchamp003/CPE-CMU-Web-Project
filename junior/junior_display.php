      ...
      <div class="container">
            <div class="row">
                  <div class="col-sm-4 col-xs-12">
                    <div class="juniorPhoto">
                      <img src="<?=$row["img"]?>" alt="img class="img-rounded img-responsive">
                    </div>
                  </div>
                  <div class="col-sm-8 col-xs-12">
                    <div class="juniorInfo">
                          <div class="juniorProfession bg-color-3">รหัสนักศึกษา</div>
                          <div class="professionDetails"><?=$row["student_id"]?></div>
                          <h3><?=$row["firstname"]?> <?=$row["lastname"]?></h3>
                          <div class="juniorProfession bg-color-3">ชื่อเล่น</div>
                          <div class="professionDetails"><?=$row["nickname"]?></div>
                          <div class="juniorProfession bg-color-4">เพศ</div>
                          <div class="professionDetails"><?=$row["gender"]?></div>
                          <div class="juniorProfession bg-color-6">อายุ</div>
                          <div class="professionDetails"><?=$row["age"]?></div>
                          <div class="juniorProfession bg-color-7">โรงเรียน</div>
                          <div class="professionDetails"><?=$row["school"]?></div>
                          <div class="juniorProfession bg-color-8">เข้าศึกษา</div>
