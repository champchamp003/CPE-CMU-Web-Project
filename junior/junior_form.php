            ...
            <div class="container">
                ...
                <div class="panel panel-default formPanel">
                          <div class="panel-heading bg-color-1 border-color-1">
                            <h3 class="panel-title">นักศึกษาปีที่ 3</h3>
                          </div>
                          <div class="panel-body">
                                <form action="junior_add.php" method="POST" role="form" enctype="multipart/form-data">
...
<section id="list" class="testimonials">
    ...
    // Check connection
            ...
            ?>
            <div class="col-xs-12">
                <h3 class="color-1">จำนวนนักศึกษาปีที่ 3 รวมทั้งสิ้น <?=$result->num_rows?> คน</h3>
                ...
                <tbody>
                   <?php while($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><a href="junior_form_edit.php?id=<?=$row["id"]?>"><i class="fa fa-pencil-square-o"></a></td>
                        <td><a href="junior_delete.php?id=<?=$row["id"]?>"><i class="fa fa-times"></td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
        </table>
