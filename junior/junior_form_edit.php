            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav scroll-to navbar-right">
                        ...
                        <li><a href="junior_form.php">Form</a></li>
            ...
            <div class="container">
                ...
                <div class="panel panel-default formPanel">
                          ...
                          <div class="panel-body">
                                <form action="junior_edit.php?id=<?=$row["id"]?>" method="POST" role="form" enctype="multipart/form-data">
                                 ...
                                 <form action="junior_img_edit.php?id=<?=$row["id"]?>" method="POST" role="form" enctype="multipart/form-data">
