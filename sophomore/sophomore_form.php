             ...
             <div class="col-xs-offset-1 col-xs-10">
                <div class="panel panel-default formPanel">
                          ...
                          <div class="panel-body">
                                <form action="Sophomore_add.php" method="POST" role="form" enctype="multipart/form-data">
                                      <div class="form-group formField">
                                        <div class="col-xs-12">
                                           <label for="">รหัสนักศึกษา</label>
                                           <input type="text" class="form-control" name="student_id" placeholder="รหัานักศึกษา" required>
                                        </div>
                                      </div>
                                      <div class="form-group formField">
                                        <div class="col-xs-12">
                                      ...
                                      <div class="form-group formField">
                                        ...
                                        <div class="col-xs-12">
                                              <label for="">เพศ</label>
                                               <input type="text" class="form-control" name="geืder" placeholder="เพศ" required>
                                        </div>
                                        <div class="form-group formField">
                                        <div class="col-xs-12">
                                      ...
                                      <div class="form-group formField">
                                        <div class="col-xs-12">
                                           ...
                                           <input type="text" class="form-control" name="entrence" placeholder="การเข้าศึกษา" required>
                                        </div>
                                      </div>
