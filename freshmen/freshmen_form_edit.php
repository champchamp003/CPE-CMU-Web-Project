            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav scroll-to navbar-right">
                        ...
                        <li><a href="freshmen_form.php">Form</a></li>
            ...
            <div class="container">
                ...
                <div class="panel panel-default formPanel">
                          <div class="panel-heading bg-color-1 border-color-1">
                            <h3 class="panel-title">นักศึกษาปีที่ 1</h3>
                          </div>
                          <div class="panel-body">
                                <form action="freshmen_edit.php?id=<?=$row["id"]?>" method="POST" role="form" enctype="multipart/form-data">
                                ...
                                <form action="freshmen_img_edit.php?id=<?=$row["id"]?>" method="POST" role="form" enctype="multipart/form-data">
