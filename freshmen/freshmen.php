...
<html lang="en">
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav scroll-to navbar-right">
                        ...
                        <li><a href="#Freshmen">Freshmen</a></li>
                    </ul>
                </div><!--/.nav-collapse -->
            </div><!--/.container-fluid -->
        </nav>
    ...
    // Check connection
        ...
        <section id="freshmen" class="about-section">
            <div class="container">
                <div class="row">
                 ...
                 <?php while($row = $result->fetch_assoc()): ?>
                    <div class="col-md-3 col-sm-6 text-center">
                        <div class="img-service-box">
                            <a href="freshmen_display.php?id=<?=$row["id"]?>"><img src="<?=$row["img"]?>" width="200" height="200" class="img-circle " alt=""></a>
                            <span class="center-line"></span>
                            <h3><?=$row["firstname"]?></h3>
                            <h3><?=$row["lastname"]?></h3>
                        </div>
